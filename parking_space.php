...
<body>
	...
	<hr />
	   ...
	   <select name="street" class="cjComboBox" >
	        ...
	        <!--parking spacess drop down  -->
			<option value="CITY HALL">CITY HALL - Cars Only</option>
			<option value="HOSPITAL">HOSPITAL - Lories and Cars</option>
			<option value="Nelumpokuna">Nelumpokuna - Cars Only</option>
			<option value="Gallface Moll">Gallface Moll - Lories and Cars</option>
	...
	<input type="text" name="account" placeholder="Cash or Card" required title="Credit card number" maxlength="14"/> 
